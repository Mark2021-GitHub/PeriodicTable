...
function setupElement() {
  ...
  n++;
  elements[17] = new Element(17, "Cl", "Chlorine", "염소", 17, 3, nm_ha, [2,8,7,0,0,0,0], gas,  "1차 세계대전 때 독가스로 사용돼기도 했지만, 오늘날에는 살균, 소독을 위해 수돗물과 수영장 물에 쓰인다. '락스'라고 알려진 염소가 포함된 표백제는 옷을 몇 분만에 표백시킨다. 전세계적으로 사용되어 온 DDT 라는 염소 기반 농약은 가장 효과적인 살충제로 많이 이용됐는데 심각한 환경오염과 생태계를 파괴하는 사실이 뒤늦게 밝혀져 지금은 거의 사용하지 않는다. 상온에서 자극적인 냄새가 있는 황록색 기체로 존재한다.");
  n++;
 ...
 elements[n] = new Element(81, "Tl", "Thallium", "탈륨", 13, 6, m_pt, [2,8,18,32,18,3,0],  solid, ": ");
  ...
  n++;
  elements[n] = new Element(87, "Fr", "Francium", "프랑슘", 1, 7, m_al,[2,8,18,32,18,8,1],  solid, ": ");
  n++;
