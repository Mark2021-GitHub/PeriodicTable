...
function setupElement() {
  ...
  n++;
  elements[13] = new Element(13,"Al","Aluminium","알루미늄",13,3, m_pt, [2,8,3,0,0,0,0],  solid, "알루미늄은 은백색을 띤 가볍고, 부드럽고 연성(당기면 늘어나는 성질)과 전성(두드리면 펴지는 성질)이 뛰어나 얇은 금박으로 쉽게 가공되는 금속이다. 가정용 알루미늄 포일은 순도 99%의 알루미늄이다.또한 전기가 잘통하므로 고압 전선에 사용되고, 열 전도성도 뛰어나 냄비나 주전자로도 사용된다.", 660, 2520, "2.698g/cm3");
  n++;
  elements[14] = new Element(14,"Si","Silicon","규소 / 실리콘",14,3, ml, [2,8,4,0,0,0,0], solid,  "반도체 소자 재료와 태양전지의 재료로 사용되는 규소는  지구의 지각에서 산소 다음으로 풍부하게 존재하는 원소이다. 규소는 다른 원자와 공유할 수 있는 원자가전자가 4개인 준금속 원소로, 다양한 화학 결합을 할 수 있다. 탄소와 비슷하게 주로 4개의 결합을 가지므로 적절한 조건 하에서 다양한 화합물을 만들 수 있다. ", 1412, 3266, "2.329g/cm3");
  n++;
    elements[15] = new Element(15, "P", "Phosphorus", "인", 15, 3, nm_re, [2,8,5,0,0,0,0], solid,  "소변에서 추출되는 생체 화합물의 필수 원소인 비금속 인에는 백린, 적린, 흑린 등의 동소체가 있다. 현재 성냥은 성냥갑의 적갈색 부분이 적린과 황화 안티모니의 혼합물로 도포되어 있다. 성냥개비 끝부분에는 산화제(염소산 포타슘)와 가연제(황) 및 마찰재(유리가루)의 혼합물이 발라져 있다. 성냥개비를 성냥갑에 문지르면 마찰열로 적린이 산화되고 그 반응열에 의해 성냥개비의 가연제가 산화제의 도움을 받아 불꽃을 내며 연소된다. 인체 내에는 체중이 70kg인 성인의 경우 700g정도의 인이 들어 있고, 인 화합물은 식물의 비료로도 매우 중요하다.  ", 44 , 280, "1.82g/cm3");
  n++;
  ...
  n++;
  elements[18] = new Element(18, "Ar", "Argon", "아르곤", 18, 3, nm_ng, [2,8,8,0,0,0,0], gas, "헬륨이나 네온과 같이 반응성이 거의 없는 비활성 기체인 아르곤은 고체, 액체, 기체 상태 모두 무색, 무취인 불연성의 기체이다. 물에 대한 용해도는 산소와 비슷하며, 질소보다는 약 2.5배가량 더 용해된다. 대부분의 경우 화학적으로 매우 안정하여 화합물을 형성하지 않는다. 아르곤은 대기 중에 부피 비율로는 약 0.934%, 질량 비율로 약 1.288%가 포함되어 있다. 고온에서 2원자 물질인 질소가 불안정한데 반하여, 1원자 물질인 아르곤은 고온에서도 안정하다. 따라서 고온에서의 비활성 기체(inert gas)가 요구되는 곳에 많이 사용된다. 또한 네온과 함께 PDP (플라즈마 액정 표시장치)의 내부에 플라즈마 형성을 위해 사용되고, 백열등 내부에서 텅스텐 필라멘트가 산화되지 않도록 하기 위한 충전가스로도 사용된다. 청록색의 아르곤 레이저는 종양 제거 등의 목적으로 이용되며, 잠수부들이 사용하는 산소통의 혼합기체로 사용되기도 한다.", -189, -186, "1.784g/L" );
  n++;
  ...
  n++;
  elements[24] = new Element(24, "Cr", "Chromium", "크로뮴", 6, 4, m_tr, [2,8,13,1,0,0,0], solid,  "크로뮴은 광택이 있는 단단한 금속으로 잘 녹지 않지만 쉽게 산화된다. 실온에서 반강자성을 띠는 유일한 금속 원소이며, 38°C 이상에서는 상자성으로 전환된다. 공기 중의 산소와 접촉하면 쉽게 얇은 산화막을 형성하여 그 아래의 금속 부분을 보호한다. 이때 생성되는 산화 피막은 원자 몇 개 정도의 두께로 매우 얇지만 밀도가 높아 산소가 침투하지 못한다. 이러한 현상은 산화제와 반응할 때 더 활발하게 일어나며, 산과 접촉하여 생기는 피막은 질산과 같은 강산과도 잘 반응하지 않는다. 크로뮴을 포함한 합금은 부식에 강하고 단단하기 때문에 활용 범위가 매우 넓다. 한 예로 스테인리스 스틸(스테인리스강)은 철에 11%이상의 크로뮴을 첨가하면 녹, 부식이 일반 강철에 비해서 적어 부식저항 강철이라 불리며 요리기구, 수술기구, 산업용 및 건설 재료, 자동차와 항공우주 구조물 등에 널리 사용된다.", 1860, 2670, "7.188g/cm3");
  n++;
 ...
 elements[27] = new Element(27, "Co", "Cobalt", "코발트", 9, 4, m_tr, [2,8,15,2,0,0,0],  solid, "코발트는 타일이나 도자기의 푸른빛을 내는 데 사용해 왔다.", 1490, 2870, "8.9g/cm3");
  ...
  n++;
  elements[46] = new Element(46,"Pd","Palladium","팔라듐",10, 5, m_tr, [2,8,18,18,0,0,0], solid,  "팔라듐은 영국의 화학자가 조제백금으로 백금을 만들다가 발견해 분리한 광택이 있는 은백색의 금속으로 전성 및 연성이 풍부하다. 치과 소재로 쓰이며, 은니에는 20% 이상의 팔라듐이 함유되어 있다. 백금과 비슷한 촉매작용이 있어서 자동차 매연 감소를 위한 촉매변환기에서 일산화탄소, 미연소 탄화수소를 탄산가스와 물로 변화시키는 산화촉매로 쓰인다. 또 부식과 마모에 강해서 커넥터나 스위치, 릴레이 등 전기 접점 도금 등이나 전극 등에 비싼 금 대신 팔라듐 합금이 널리 쓰인다.");
  n++;
  ...
  n++;
  elements[50] = new Element(50, "Sn", "Tin (Stannum)", "주석", 14, 5, m_pt, [2,8,18,18,4,0,0], solid,  "주석은 녹는점이 232도로 비교적 낮아서 땜납의 재료로 쓰이고, 동상에 사용되는 청동은 구리와 주석의 합금이다. 녹이 잘 슬지 않는 주석을 철에 도금한 양철은 통조림 깡통이나 양동이를 만드는데 사용된다.", 232, 2603, "7.31g/cm3");
  n++;
  ...
  n++;
  elements[53] = new Element(53, "I", "Iodine", "아이오딘/요오드", 17, 5, nm_ha, [2,8,18,18,7,0,0],  solid, "아이오딘의 홑원소 물질은 상온에서는 흑자색 고체로, 열을 가하면 고체에서 기체로 승화하는 물질이다. 아이오딘의 홑원소 물질은 물에 잘 녹지 않으나, 아이오딘화포타슘(KI) 수용액에는 녹아서 갈색의 아이오딘-아이오딘화포타슘 용액이 된다. 이 용액에 녹말을 넣으면 녹말의 색깔이 보라색(청람색,청자색)으로 변하는 아이오딘 녹말 반응이 나타나므로 녹말을 검출하는데 이용된다. 빨간 소독약(포비돈-아이오딘)으로도 유명한 아이오딘은 다른 17족(할로젠) 원소들 처럼 우수한 소독 효과를 가지고 있다. 미역, 김등의 해조료와 천일염등에 풍부한 아이오딘은 우리 몸의 갑상선 호르몬의 구성 원소이다. 아이오딘이 부족하면 목이 부풀어 오르는 갑상선 비대증이 생기고 심하면 뇌까지 손상된다. 진공 상태의 전구 안에 브로민이나 아이오딘을 넣은 할로젠 램프로도 사용된다.", 114, 184, "4.93g/cm3");
  n++;
  ...
  n++;
  elements[n] = new Element(79, "Au", "Gold (Aurum)", "금", 11, 6, m_tr, [2,8,18,32,18,1,0],  solid, "금은 노란색을 띠는 금속으로 연성과 전성이 매우 뛰어나 길게 늘이거나 얇게 펼 수 있다. 일례로 가로, 세로, 높이가 모두 1인치인 정육면체의 금을 넓게 펴면 가로, 세로, 높이가 모두 10미터인 공간을 뒤덮을 수 있을 만큼 넓게 펴진다. 금 1그램으로는 3000미터 이상의 금선도 제작이 가능하다. 또한 금은 어떠한 경우에도 녹이 슬지 않기 때문에 도금을 이용하여 장신구 제작에 많이 사용되었다. 금은 굉장히 무거운 금속으로서 이 세상에 존재하는 모든 원소들 중 금보다 무거운 원소는 많지 않다.  공기 중에서 전혀 부식되지 않고 다른 화학변화도 일으키지 않기 때문에, 표면의 색이 그대로 보존된다. 금의 부드러운 성질 때문에 순금으로는 작은 충격에도 모양이 쉽게 변하는 특성 탓에 금으로 장신구를 만들려면 다른 금속과 결합한 금합금을 이용한다. 금 합금은 보통 원래의 순금에 다른 금속을 넣는데, 그 비율에 따라 22K, 18K, 14K, 그리고 10K 네 가지가 있다. 구리는 금 합금을 만들때의 기본 금속이며, 적갈색의 광택을 띤다. 18캐럿의 금 합금은 순금에 25%의 구리를 넣어서 만들며, 14캐럿의 금 합금은 역시 구리를 넣어서 만드는데, 색은 청동과 같은 색깔을 띤다.높은 캐럿 단위(20-22K)의 금은 순금에다 은을 넣어서 만든다.", 1064, 2857, "19.32g/cm3");
  n++;
 ...
 elements[n] = new Element(81, "Tl", "Thallium", "탈륨", 13, 6, m_pt, [2,8,18,32,18,3,0],  solid, ": ");
  n++;  
  elements[n] = new Element(82, "Pb", "Lead (Plumbum)", "납", 14, 6, m_pt, [2,8,18,32,18,4,0],  solid, "녹는점(327도)이 낮고 무르고 가공하기 쉬워 고대부터 수도관, 식기 등 수많은 일상용품에 유용하게 사용된 금속. 20세기 중반에 납의 유독성과 중독 증상이 밝혀져 지금은 일상용품으로는 사용이 엄격하게 제한됨.", 328, 1750, "11.35g/cm3");
  n++;
